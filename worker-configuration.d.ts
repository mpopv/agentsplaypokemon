/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c11aeb3bb700a98a66b9ce65a8720b6f)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	PRIVATE_DATA: R2Bucket;
	ASSETS: Fetcher;
	DEFAULT_ROOM_ID: "main";
	VOTE_WINDOW_MS: "10000";
	COMPUTER_EXEC_TIMEOUT_MS: "5000";
	COMPUTER_OUTPUT_LIMIT_BYTES: "65536";
	SNAPSHOT_INTERVAL_MINUTES: "15";
	GAME_ROOMS: DurableObjectNamespace<import("./worker/index").GameRoomDO>;
	SHARED_COMPUTERS: DurableObjectNamespace<import("./worker/index").SharedComputerDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GameRoomDO" | "SharedComputerDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_ROOM_ID" | "VOTE_WINDOW_MS" | "COMPUTER_EXEC_TIMEOUT_MS" | "COMPUTER_OUTPUT_LIMIT_BYTES" | "SNAPSHOT_INTERVAL_MINUTES">> {}
}
